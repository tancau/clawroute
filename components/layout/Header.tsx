        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg border border-border-subtle text-neutral-7 hover:text-neutral-10 hover:border-brand-primary/50 transition-all duration-fast text-sm"
            >
