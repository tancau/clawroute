...
export const metadata: Metadata = {
  title: 'Terms of Service - HopLLM',
  description: 'HopLLM terms of service. Read our service agreement and usage policies.',
};
    ...
    <div className="min-h-screen py-12 px-4">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-6">
          ...
          <section className="card-glass p-6 rounded-xl">
            <h2 className="text-xl font-bold mb-3">{t('section7Title')}</h2>
            <p className="text-neutral-7 leading-relaxed">{t('section7Content')}</p>
          </section>

          <div className="text-center text-sm text-neutral-6 mt-8">
            <p>{t('lastUpdated')}</p>
            <p className="mt-2">{t('contactUs')}: <a href="mailto:legal@hopllm.com" className="text-brand-primary hover:underline">legal@hopllm.com</a></p>
          </div>
        </div>
      </div>
    </div>
